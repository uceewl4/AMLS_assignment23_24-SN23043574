...
"""
@File    :   DenseNet201.py
@Time    :   2023/12/16 22:11:31
@Programme :  MSc Integrated Machine Learning Systems (TMSIMLSSYS01)
@Module : ELEC0134 Applied Machine Learning Systems
@SN :   23043574
@Contact :   uceewl4@ucl.ac.uk
@Desc    :   This file is used for pretrained model DenseNet-201 as feature extractor,
...
class DenseNet201(Model):
    ...
    """
    description: This function is used for initialization of DenseNet-201 + classifiers.
    param {*} self
    ...
    def __init__(self, method=None):
        ...
        # need resizing to satisfy the minimum image size need of Densenet-201
