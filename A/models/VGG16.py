...
"""
@File    :   VGG16.py
@Time    :   2023/12/16 21:28:39
@Programme :  MSc Integrated Machine Learning Systems (TMSIMLSSYS01)
@Module : ELEC0134 Applied Machine Learning Systems
@SN :   23043574
@Contact :   uceewl4@ucl.ac.uk
@Desc    :   This file is used for pretrained model VGG-16 as feature extractor,
  followed by 7 classifiers of ML baselines.
"""

# here put the import li
import numpy as np
...
class VGG16(Model):
    ...
    """
    description: This function is used for initialization of VGG-16 + classifiers.
    param {*} self
    ...
    def __init__(self, method=None):
        ...
        # need resizing to satisfy the minimum image size need of VGG-16
